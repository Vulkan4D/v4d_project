...
#define RAY_TRACED_ENTITY_TRANSPARENT 1<< 5
#define RAY_TRACED_ENTITY_LIGHT 1<< 6
#define RAY_TRACED_ENTITY_SOUND 1<< 7

// Masks to use for ray-tracing calls
#define RAY_TRACE_MASK_VISIBLE			RAY_TRACED_ENTITY_DEFAULT|RAY_TRACED_ENTITY_TERRAIN|RAY_TRACED_ENTITY_TERRAIN_NEGATE|RAY_TRACED_ENTITY_LIQUID|RAY_TRACED_ENTITY_ATMOSPHERE|RAY_TRACED_ENTITY_TRANSPARENT|RAY_TRACED_ENTITY_LIGHT
