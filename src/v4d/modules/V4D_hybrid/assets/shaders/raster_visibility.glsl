...
void main() {
	const vec3 cubeVertices[] = { // Backfaces
		vec3(v2g[0].aabbMin.x, v2g[0].aabbMin.y, v2g[0].aabbMin.z),
		vec3(v2g[0].aabbMax.x, v2g[0].aabbMin.y, v2g[0].aabbMin.z),
		vec3(v2g[0].aabbMin.x, v2g[0].aabbMax.y, v2g[0].aabbMin.z),
		vec3(v2g[0].aabbMax.x, v2g[0].aabbMax.y, v2g[0].aabbMin.z),
		vec3(v2g[0].aabbMin.x, v2g[0].aabbMin.y, v2g[0].aabbMax.z),
		vec3(v2g[0].aabbMax.x, v2g[0].aabbMin.y, v2g[0].aabbMax.z),
		vec3(v2g[0].aabbMin.x, v2g[0].aabbMax.y, v2g[0].aabbMax.z),
		vec3(v2g[0].aabbMax.x, v2g[0].aabbMax.y, v2g[0].aabbMax.z),
	};
