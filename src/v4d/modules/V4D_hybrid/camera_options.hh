...
#define GEOMETRY_ATTR_PRIMARY_VISIBLE 1<< 1
#define GEOMETRY_ATTR_CAST_SHADOWS 1<< 2
#define GEOMETRY_ATTR_REFLECTION_VISIBLE 1<< 3
#define GEOMETRY_ATTR_COLLIDER 1<< 4
// Only one of the following can be used
#define GEOMETRY_ATTR_SOLID 1<< 5
#define GEOMETRY_ATTR_WATER 1<< 6
#define GEOMETRY_ATTR_FOG 1<< 7
#define GEOMETRY_ATTR_ATMOSPHERE 1<< 8
