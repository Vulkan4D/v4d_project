...
// Modules
	...
	#define APP_DEFAULT_MODULES APP_MAIN_RENDER_MODULE,APP_MAIN_MULTIPLAYER_MODULE,"V4D_sample","V4D_flycam","V4D_bullet","V4D_galaxy4d","V4D_planetdemo","V4D_buildsystem","V4D_avatar"
