...
// Modules
	...
	#define APP_DEFAULT_MODULES APP_MAIN_RENDER_MODULE,APP_MAIN_MULTIPLAYER_MODULE,"V4D_andromeda","V4D_flycam","V4D_buildsystem","V4D_galaxy4d","G4D_models"
...
// Networking
	...
	#define APP_NETWORKING_MAX_ACTION_STREAMS_PER_SECOND 5
