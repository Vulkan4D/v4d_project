...
namespace app::networking {
	...
	namespace action {
		...
		const Action SYNC_OBJECT_TRANSFORM = 16; // + (objectID, iteration, NetworkGameObjectTransform) = 128 bytes + CustomTransformData
	}
}

#define CUSTOM_OBJECT_DATA_INITIAL_STREAM_SIZE 512
#define CUSTOM_OBJECT_TRANSFORM_DATA_MAX_STREAM_SIZE 144
