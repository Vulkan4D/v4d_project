...
public:
	Instance(Loader* loader, const char* applicationName, uint applicationVersion) : vulkanLoader(loader) {
		this->loader = loader;
	...
	virtual ~Instance() {
		...
		for (auto *physicalDevice : availablePhysicalDevices) delete physicalDevice;
	}
